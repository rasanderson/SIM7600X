...
phone_number = '07814998395' #********** change it to the phone number you want to call
#phone_number = '150' # EE number for balance
text_message = 'BALANCE' # Send text message of balance should return current status
power_key = 6
rec_buff = ''
